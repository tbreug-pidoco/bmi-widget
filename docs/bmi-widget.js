...
`;class M{constructor(t,r){l(this,"dialog");this.dialog=h("div",`${e}_info`),this.dialog.hidden=!0;const o=h("p"),a=h("button");o.innerText=n("info",r),a.innerText=n("close",r),this.dialog.appendChild(o),this.dialog.appendChild(a);const i=h("button",`${e}_info-button`);i.innerHTML=v,t.appendChild(i),t.appendChild(this.dialog),i.onclick=()=>{this.dialog.hidden&&setTimeout(()=>this.dialog.hidden=!1,0)},a.onclick=()=>this.dialog.hidden=!0,this.dialog.onclick=d=>d.stopPropagation(),document.addEventListener("click",()=>this.dialog.hidden=!0)}}var m=(s=>(s[s.female=0]="female",s[s.male=1]="male",s))(m||{});const f=[[{age:19,normal:[18,23],over:[24,28]},{age:25,normal:[19,24],over:[25,28]},{age:35,normal:[20,25],over:[26,30]},{age:45,normal:[21,26],over:[27,30]},{age:55,normal:[22,27],over:[28,31]},{age:65,normal:[23,28],over:[29,31]}],[{age:19,normal:[19,24],over:[25,29]},{age:25,normal:[20,25],over:[26,29]},{age:35,normal:[21,26],over:[27,29]},{age:45,normal:[22,27],over:[28,30]},{age:55,normal:[23,28],over:[29,31]},{age:65,normal:[24,29],over:[30,31]}]],g=(s,t,r)=>{const o=n(s,t);return r?o.replace(/%BMI_FROM%/g,r[0].toString()).replace(/%BMI_TO%/g,r[1].toString()):o},I=(s,t,r,o)=>{for(let a=f[s].length-1;a>=0;a--){const i=f[s][a];if(r>=i.age)return t<i.normal[0]?g("underweight",o,i.normal):t<=i.normal[1]?g("normalweight",o,i.normal):t<=i.over[1]?g("overweight",o,i.normal):g("obese",o,i.normal)}return g("young",o)};class k{constructor(t){l(this,"language");l(this,"container");l(this,"female");l(this,"male");l(this,"age");l(this,"weight");l(this,"size");l(this,"calc");l(this,"result");l(this,"bmi");l(this,"note");this.language=(t.getAttribute("data-language")||"de").toLowerCase();const r=document.createElement("style");r.innerHTML=w.replace(/^\s+|\n/gm,""),t.before(r),this.container=h("div",e);const o=h("h2");o.innerText=n("calculator",this.language),this.container.appendChild(o);const a=h("form"),i=h("div",`${e}_gender`);this.female=b(i,"female","gender","0",!0,n("female",this.language)),this.male=b(i,"male","gender","1",!1,n("male",this.language)),this.female.onchange=()=>this.calculate(),this.male.onchange=()=>this.calculate(),a.appendChild(i);const d=h("div",`${e}_values`);this.age=new u(d,n("years",this.language),n("age",this.language),this),this.weight=new u(d,n("kg",this.language),n("weight",this.language),this),this.size=new u(d,n("cm",this.language),n("size",this.language),this),this.calc=h("button",`${e}_calc`),this.calc.type="submit",this.calc.disabled=!0,this.calc.innerText=n("calculate",this.language),d.appendChild(this.calc),a.onsubmit=B=>{B.preventDefault(),this.calculate()},a.appendChild(d),this.container.appendChild(a),this.result=h("div",`${e}_result`),this.result.hidden=!0;const p=h("p",`${e}_bmi`);p.innerHTML=`${n("bmi",this.language)}: <span></span>`,this.bmi=p.getElementsByTagName("span")[0],this.result.appendChild(p),this.note=h("p",`${e}_note`),this.result.appendChild(this.note),this.container.appendChild(this.result),t.replaceWith(this.container),new M(this.container,this.language)}changed(t){this.result.hidden=!0,this.calc.disabled=!this.valid,this.age.valid=!0,this.weight.valid=!0,this.size.valid=!0}calculate(){if(this.valid){const t=this.age.parse,r=this.weight.parse,o=this.size.parse;if(r<20||r>350)this.result.classList.add("error"),this.weight.valid=!1,this.note.innerText=n("errorWeight",this.language);else if(o<50||o>250)this.result.classList.add("error"),this.size.valid=!1,this.note.innerText=n("errorSize",this.language);else{const a=this.female.checked?m.female:m.male,i=Math.round(r/Math.pow(o/100,2)*10)/10;this.bmi.innerText=new Intl.NumberFormat(this.language).format(i),this.note.innerHTML=I(a,i,t,this.language),this.result.classList.remove("error")}this.result.hidden=!1,this.calc.disabled=!0,setTimeout(()=>{const a=this.result.getBoundingClientRect();(a.top<0||a.left<0||a.bottom>window.innerHeight||a.right>window.innerWidth)&&this.result.scrollIntoView({block:"end",behavior:"smooth"})},50)}}get valid(){return this.age.valid&&this.weight.valid&&this.size.valid}}(function(){const s=document.getElementsByTagName("script");for(const t of s)t.src.indexOf("bmi-widget")>=0&&new k(t)})()})();
