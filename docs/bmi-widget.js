var y=Object.defineProperty;var I=(r,e,i)=>e in r?y(r,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):r[e]=i;var s=(r,e,i)=>I(r,typeof e!="symbol"?e+"":e,i);const t="bmi-widget",h=(r,e=void 0)=>{const i=document.createElement(r);return e&&(i.className=e),i},f=(r,e,i,a,o,n)=>{const c=h("label");return c.innerHTML=`<input type="radio" id="${e}" name="${i}" value="${a}" ${o?"checked":""}/>${n}`,r.appendChild(c),c.getElementsByTagName("input")[0]};class d{constructor(e,i,a,o){s(this,"units");s(this,"listener");s(this,"element");this.units=i,this.listener=o,this.element=h("input"),this.element.placeholder=a,this.element.onkeydown=n=>{n.keyCode>=65&&n.preventDefault()},this.element.onchange=()=>{const n=this.parse;this.element.value=isNaN(n)?"":n.toString()+" "+this.units},this.element.oninput=()=>this.listener.changed(this),e.appendChild(this.element)}get parse(){return parseInt(this.element.value)}get isValid(){const e=this.parse;return!isNaN(e)&&e>0}get html(){return this.element}}const x=`
	.${t} * {
