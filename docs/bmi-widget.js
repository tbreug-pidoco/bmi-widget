var y=Object.defineProperty;var x=(e,n,c)=>n in e?y(e,n,{enumerable:!0,configurable:!0,writable:!0,value:c}):e[n]=c;var h=(e,n,c)=>x(e,typeof n!="symbol"?n+"":n,c);(function(){"use strict";const e="bmi-widget",n=(s,t)=>{const r=document.createElement(s);return t&&(r.className=t),r},c=(s,t,r,o,a,i)=>{const d=n("label");return d.innerHTML=`<input type="radio" id="${t}" name="${r}" value="${o}" ${a?"checked":""}/>${i}`,s.appendChild(d),d.getElementsByTagName("input")[0]};class u{constructor(t,r,o,a){h(this,"units");h(this,"listener");h(this,"element");this.units=r,this.listener=a,this.element=n("input"),this.element.placeholder=o,this.element.onkeydown=i=>{i.keyCode>=65&&i.preventDefault()},this.element.onchange=()=>{const i=this.parse;this.element.value=isNaN(i)?"":i.toString()+" "+this.units},this.element.oninput=()=>this.listener.changed(this),t.appendChild(this.element)}set valid(t){t?this.element.classList.remove("invalid"):(this.element.classList.add("invalid"),this.element.setSelectionRange(0,-1),this.element.focus())}get parse(){return parseInt(this.element.value)}get isValid(){const t=this.parse;return!isNaN(t)&&t>0}}const w=`
	.${e} * {
