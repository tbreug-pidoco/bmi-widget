...
`;class I{constructor(t,r){h(this,"dialog");this.dialog=l("div",`${e}_info`),this.dialog.hidden=!0;const a=l("p"),s=l("button");a.innerText=n("info",r),s.innerText=n("close",r),this.dialog.appendChild(a),this.dialog.appendChild(s);const i=l("button",`${e}_info-button`);i.title="Info",i.innerHTML=v,t.appendChild(i),t.appendChild(this.dialog),i.onclick=()=>{this.dialog.hidden&&setTimeout(()=>this.dialog.hidden=!1,0)},s.onclick=()=>this.dialog.hidden=!0,this.dialog.onclick=d=>d.stopPropagation(),document.addEventListener("click",()=>this.dialog.hidden=!0)}}var p=(o=>(o[o.female=0]="female",o[o.male=1]="male",o))(p||{});const b=[[{age:19,normal:[18,23],over:[24,29]},{age:25,normal:[19,24],over:[25,28]},{age:35,normal:[20,25],over:[26,30]},{age:45,normal:[21,26],over:[27,30]},{age:55,normal:[22,27],over:[28,31]},{age:65,normal:[23,28],over:[29,31]}],[{age:19,normal:[19,24],over:[25,29]},{age:25,normal:[20,25],over:[26,29]},{age:35,normal:[21,26],over:[27,29]},{age:45,normal:[22,27],over:[28,30]},{age:55,normal:[23,28],over:[29,31]},{age:65,normal:[24,29],over:[30,31]}]],u=(o,t,r)=>{const a=n(o,t);return r?a.replace(/%BMI_FROM%/g,r[0].toString()).replace(/%BMI_TO%/g,r[1].toString()):a},M=(o,t,r,a)=>{for(let s=b[o].length-1;s>=0;s--){const i=b[o][s];if(r>=i.age)return t<i.normal[0]?u("underweight",a,i.normal):t<=i.normal[1]?u("normalweight",a,i.normal):t<=i.over[1]?u("overweight",a,i.normal):u("obese",a,i.normal)}return u("young",a)};class y{constructor(t){h(this,"language");h(this,"container");h(this,"female");h(this,"male");h(this,"age");h(this,"weight");h(this,"size");h(this,"calc");h(this,"result");h(this,"bmi");h(this,"note");this.language=(t.getAttribute("data-language")||"de").toLowerCase();const r=document.createElement("style");r.innerHTML=w.replace(/^\s+|\n/gm,""),t.before(r),this.container=l("div",e);const a=l("h2");a.innerText=n("calculator",this.language),this.container.appendChild(a);const s=l("form"),i=l("div",`${e}_gender`);this.female=f(i,"female","gender","0",!0,n("female",this.language)),this.male=f(i,"male","gender","1",!1,n("male",this.language)),this.female.onchange=this.male.onchange=()=>{this.age.valid&&this.weight.valid&&this.size.valid&&this.calculate()},s.appendChild(i);const d=l("div",`${e}_values`);this.age=new m(d,n("age",this.language),n("years",this.language),this),this.weight=new m(d,n("weight",this.language),n("kg",this.language),this),this.size=new m(d,n("size",this.language),n("cm",this.language),this),this.calc=l("button",`${e}_calc`),this.calc.type="submit",this.calc.innerText=this.calc.title=n("calculate",this.language),d.appendChild(this.calc),s.onsubmit=x=>{x.preventDefault(),this.calculate()},s.appendChild(d),this.container.appendChild(s),this.result=l("div",`${e}_result`),this.result.hidden=!0;const g=l("p",`${e}_bmi`);g.innerHTML=`${n("bmi",this.language)}: <span></span>`,this.bmi=g.getElementsByTagName("span")[0],this.result.appendChild(g),this.note=l("p",`${e}_note`),this.result.appendChild(this.note),this.container.appendChild(this.result),t.replaceWith(this.container),new I(this.container,this.language)}changed(t){this.result.hidden=!0,this.age.valid=!0,this.weight.valid=!0,this.size.valid=!0}calculate(){const t=this.age.parse,r=this.weight.parse,a=this.size.parse;if(isNaN(t)||t<=0)this.result.classList.add("error"),this.age.valid=!1,this.note.innerText=n("errorAge",this.language);else if(isNaN(r)||r<20||r>350)this.result.classList.add("error"),this.weight.valid=!1,this.note.innerText=n("errorWeight",this.language);else if(isNaN(a)||a<50||a>250)this.result.classList.add("error"),this.size.valid=!1,this.note.innerText=n("errorSize",this.language);else{const s=this.female.checked?p.female:p.male,i=Math.round(r/Math.pow(a/100,2)*10)/10;this.bmi.innerText=new Intl.NumberFormat(this.language).format(i),this.note.innerHTML=M(s,i,t,this.language),this.result.classList.remove("error")}this.result.hidden=!1,setTimeout(()=>{const s=this.result.getBoundingClientRect();(s.top<0||s.left<0||s.bottom>window.innerHeight||s.right>window.innerWidth)&&this.result.scrollIntoView({block:"end",behavior:"smooth"})},100)}}(function(){const o=document.getElementsByTagName("script");for(const t of o)t.src.indexOf("bmi-widget")>=0&&new y(t)})()})();
