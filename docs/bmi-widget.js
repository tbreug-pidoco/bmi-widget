var k=Object.defineProperty;var F=(e,n,g)=>n in e?k(e,n,{enumerable:!0,configurable:!0,writable:!0,value:g}):e[n]=g;var h=(e,n,g)=>F(e,typeof n!="symbol"?n+"":n,g);(function(){"use strict";const e="bmi-widget",n=(a,t)=>{const r=document.createElement(a);return t&&(r.className=t),r},g=(a,t,r,s,o,i)=>{const d=n("label");return d.innerHTML=`<input type="radio" id="${t}" name="${r}" value="${s}" ${o?"checked":""}/>${i}`,a.appendChild(d),d.getElementsByTagName("input")[0]};class u{constructor(t,r,s,o){h(this,"units");h(this,"listener");h(this,"element");this.units=r,this.listener=o,this.element=n("input"),this.element.placeholder=s,this.element.onkeydown=i=>{i.keyCode>=65&&i.preventDefault()},this.element.onchange=()=>{const i=this.parse;this.element.value=isNaN(i)?"":i.toString()+" "+this.units},this.element.oninput=()=>this.listener.changed(this),t.appendChild(this.element)}get parse(){return parseInt(this.element.value)}get isValid(){const t=this.parse;return!isNaN(t)&&t>0}get html(){return this.element}}const v=`
	.${e} * {
...
`;class M{constructor(t,r){h(this,"dialog");this.dialog=n("div",`${e}_dlg-info`),this.dialog.hidden=!0,this.dialog.style.zIndex=(Number(t.style.zIndex||0)+1).toString();const s=n("p"),o=n("button");s.innerText=l("infoText",r),o.innerText=l("close",r),this.dialog.appendChild(s),this.dialog.appendChild(o);const i=n("button",`${e}_dlg-info--button`);i.innerHTML=I,t.appendChild(i),t.appendChild(this.dialog),i.onclick=()=>{this.dialog.hidden&&setTimeout(()=>this.dialog.hidden=!1,0)},o.onclick=()=>this.dialog.hidden=!0,this.dialog.onclick=d=>d.stopPropagation(),document.addEventListener("click",()=>this.dialog.hidden=!0)}}var p=(a=>(a[a.female=0]="female",a[a.male=1]="male",a))(p||{});const b=[[{age:19,normal:[18,23],over:[19,24]},{age:25,normal:[19,24],over:[25,28]},{age:35,normal:[20,25],over:[26,30]},{age:45,normal:[21,26],over:[27,30]},{age:55,normal:[22,27],over:[28,31]},{age:65,normal:[23,28],over:[29,31]}],[{age:19,normal:[19,24],over:[25,29]},{age:25,normal:[20,25],over:[26,29]},{age:35,normal:[21,26],over:[27,29]},{age:45,normal:[22,27],over:[28,30]},{age:55,normal:[23,28],over:[29,31]},{age:65,normal:[24,29],over:[30,31]}]],c=(a,t,r)=>{const s=l(a,t);return r?s.replace(/%BMI_FROM%/g,r[0].toString()).replace(/%BMI_TO%/g,r[1].toString()):s},x=(a,t,r,s)=>{for(let o=b[a].length-1;o>=0;o--){const i=b[a][o];if(r>=i.age)return t<i.normal[0]?c("underweight",s,i.normal):t<=i.normal[1]?c("normalweight",s,i.normal):t<=i.over[1]?c("overweight",s,i.normal):c("obese",s,i.normal)}return c("young",s)};class y{constructor(t){h(this,"language");h(this,"container");h(this,"female");h(this,"male");h(this,"age");h(this,"weight");h(this,"size");h(this,"calc");h(this,"result");h(this,"bmi");h(this,"note");h(this,"info");this.language=(t.getAttribute("data-language")||"de").toLowerCase();const r=document.createElement("style");r.innerHTML=v.replace(/^\s+|\n/gm,""),t.before(r),this.container=n("div",e),this.info=new M(this.container,this.language);const s=n("h2");s.innerText=l("calculator",this.language),this.container.appendChild(s);const o=n("form"),i=n("div",`${e}_gender`);this.female=g(i,"female","gender","0",!0,l("female",this.language)),this.male=g(i,"male","gender","1",!1,l("male",this.language)),this.female.onchange=()=>this.calculate(),this.male.onchange=()=>this.calculate(),o.appendChild(i);const d=n("div",`${e}_values`);this.age=new u(d,l("years",this.language),l("age",this.language),this),this.weight=new u(d,l("kg",this.language),l("weight",this.language),this),this.size=new u(d,l("cm",this.language),l("size",this.language),this),this.calc=n("button",`${e}_calc`),this.calc.type="submit",this.calc.disabled=!0,this.calc.innerText=l("calculate",this.language),d.appendChild(this.calc),o.onsubmit=B=>{B.preventDefault(),this.calculate()},o.appendChild(d),this.container.appendChild(o);const w=n("p",`${e}_info`);w.innerText=l("info",this.language),this.container.appendChild(w),this.result=n("div",`${e}_result`),this.result.hidden=!0;const f=n("p",`${e}_bmi`);f.innerHTML=`${l("bmi",this.language)}: <span></span>`,this.bmi=f.getElementsByTagName("span")[0],this.result.appendChild(f),this.note=n("p",`${e}_note`),this.result.appendChild(this.note),this.container.appendChild(this.result),t.replaceWith(this.container)}changed(t){this.result.hidden=!0,this.calc.disabled=!this.valid,this.age.html.classList.remove("error"),this.weight.html.classList.remove("error"),this.size.html.classList.remove("error")}calculate(){if(this.valid){const t=this.age.parse,r=this.weight.parse,s=this.size.parse;if(r<20||r>350)this.result.classList.add("error"),this.weight.html.classList.add("error"),this.note.innerText=l("errorWeight",this.language);else if(s<50||s>250)this.result.classList.add("error"),this.size.html.classList.add("error"),this.note.innerText=l("errorSize",this.language);else{const o=this.female.checked?p.female:p.male,i=Math.round(r/Math.pow(s/100,2)*10)/10;this.bmi.innerText=new Intl.NumberFormat(this.language).format(i),this.note.innerHTML=x(o,i,t,this.language),this.result.classList.remove("error")}this.result.hidden=!1,this.calc.disabled=!0}}get valid(){return this.age.isValid&&this.weight.isValid&&this.size.isValid}}(function(){const a=document.getElementsByTagName("script");for(const t of a)t.src.indexOf("bmi-widget")>=0&&new y(t)})()})();
